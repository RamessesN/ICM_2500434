...
\subsection{Other Cybercrime Incidents}\label{subsec:other-cybercrime-incedents} % 3.3
	...
	\begin{figure}[htbp]
		...
		\subfloat[Successful Cybercrime Incidents]{
			\includegraphics[width=0.8\linewidth]{./rsrc/Crime_Successful_distribution}
		}\\
		\subfloat[Mitigated Cybercrime Attempts]{
			\includegraphics[width=0.4\linewidth]{./rsrc/Crime_NearMiss_distribution}
		}\hfill
		\subfloat[Reported Cybercrime Incidents]{
			\includegraphics[width=0.4\linewidth]{./rsrc/Crime_Suspected_distribution}
		}\\
