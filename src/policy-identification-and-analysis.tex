...
\begin{figure}[htbp]
    \centering
    \subfloat[US (T1)]{
        \includegraphics[width=0.45\linewidth]{../rsrc/(T1)US_policy}
    }\hfill
    \subfloat[Japan (T2)]{
        \includegraphics[width=0.45\linewidth]{../rsrc/(T2)Japan_policy}
    }\\
    \subfloat[China (T3)]{
        \includegraphics[width=0.3\linewidth]{../rsrc/(T3)China_policy}
    }\hfill
    \subfloat[Costa Rica (T4)]{
        \includegraphics[width=0.3\linewidth]{../rsrc/(T4)Costa_Rica_policy}
    }\hfill
    \subfloat[Namibia (T5)]{
        \includegraphics[width=0.3\linewidth]{../rsrc/(T5)Namibia_policy}
    }\\
