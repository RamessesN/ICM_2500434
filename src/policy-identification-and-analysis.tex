...
\subsection{Other cybercrime indicators}\label{subsec:other-cybercrime-indicators} %4.4
    ...
    \subsubsection*{Impact on Cyberattack Success Rates}
    ...
    \subsubsection*{Analysis of Cybercrime Reporting Rate}
