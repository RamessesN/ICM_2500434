...
due to the logarithmic transformation applied during data preprocessing.
    ...
    \subsubsection{Time Series Plots}
        ...
        Figure~\ref{fig:gdp}.
        \begin{figure}[htbp]
            \includegraphics[width=1\linewidth]{../rsrc/demographics/gdp_crime_and_time}\label{fig:gdp}
        \end{figure}
    ...
    \subsubsection{Distribution Plots}
        ...
        \begin{figure}[htbp]
            \centering
            \subfloat{
                \includegraphics[width=1\linewidth]{../rsrc/demographics/Internet Users}\label{fig:internet}
            }\\
            \subfloat{
                \includegraphics[width=1\linewidth]{../rsrc/demographics/Tertiary Education}\label{fig:education}
            }\\
