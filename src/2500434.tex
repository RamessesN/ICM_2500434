...
\label{sec:symbol-and-assumptions}
...
\section{Policy Identification and Analysis}
\label{sec:policy-identification-and-analysis}
...
\section{Future Work}
\label{sec:future-work} %6
\input{future-work}

\section{Strengths \& Weaknesses}
\label{sec:strength-&-weakness}
