...
# 读取犯罪密度数据
df_population = pd.read_excel('./data/GCI with 5 factors/5项指标(Sorted).xlsx', index_col=0)
...
# 导出到Excel
filtered_df.to_excel('./result/excel/filtered_5_factors_with_sequence.xlsx')

print("处理完成，结果已保存至 './result/excel/filtered_5_factors_with_sequence.xlsx'")