...
def save_successful_countries(year_country_count, output_file):
    ...
    if not year_country_count:
        print(f"No suspected attacks found. {output_file} not created.")
        return
    ...
    print(f"Suspected countries by year saved: {output_file}")
...
def main():
    ...
    nearMiss_stats_excel = "./result/excel/suspected_countries_by_year.xlsx"  # 输出 Excel 文件路径
