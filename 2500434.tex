...
\section{Introduction} %1 
	...
	\subsection{Restatement of the problem} %1.2
	\subsection{Analysis of problems} %1.3
	
\section{Symbol and Assumptions} %2
	\subsection{Symbol Description} %2.1
	
\section{The establishment and solution of problem 1 model} %3
	\subsection{Shit, bro*1} %3.1
	
\section{The establishment and solution of problem 2 model} %4
	\subsection{Shit, bro*2} %4.1
	
\section{The establishment and solution of problem 3 model} %5
	\subsection{Shit, bro*3} %5.1
	
\section{Future expected data} %6

\section{Advantages \& Disadvantages} %7
