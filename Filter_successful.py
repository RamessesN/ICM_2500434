...
def extract_successful_countries(json_data):
    ...
    if security_incident != "Confirmed":
        return []
...
def main():
    ...
    successful_countries_count = process_json_files(json_directory)

    # 保存结果到 Excel 文件
    save_successful_countries(successful_countries_count, successful_stats_excel)
